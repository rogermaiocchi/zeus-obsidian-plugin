...
// v0.11 — guard Node-only requires so module load doesn't crash on iOS (no fs/cp).
// All public methods that depend on these will throw a clean error if called on
// iOS instead of failing at module load time.
