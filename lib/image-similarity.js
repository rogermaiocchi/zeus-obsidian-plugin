 ...
 * vault.adapter. Métodos viraram async. A extração de feature-print (Vision) exige
 * o daemon LOCAL (macOS, auto-spawn em loopback). Em iOS não há daemon — logo este
 * recurso é indisponível on-device (arquitetura on-device-pure, sem Tailscale).
 *
 * Dependências:
