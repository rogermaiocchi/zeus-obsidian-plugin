...
class ZeusHttpClient {
  ...
  async prompt(instruction, options = {}) {
    // options: { max_tokens, deterministic, prewarm, fewShotExamples }
    const body = {
      instruction,
